      ...
      {activeTab === "evidence" && (
        <div className="bg-white p-6 border-l border-r border-b rounded-b-lg">
          ...
          <div className="bg-gray-50 p-4 rounded border mb-4">
            <p className="font-medium">
              Raasveld FV, Zhang Z, Johnston BR, et al. Machine Learning Approach to Predict Pain Outcomes Following Primary and Secondary Targeted Muscle Reinnervation in Amputees. JPRAS. 2025 (In Press).
            </p>
            <p className="mt-2 text-sm text-gray-600">
