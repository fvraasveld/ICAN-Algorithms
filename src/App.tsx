...
import KneeArthroplastyAlgorithm from './components/KneeArthroplastyAlgorithm';
...
const ICANAlgorithmsLanding = () => {
  ...
  const handleToolSelect = (toolId: string) => {
    ...
    } else if (toolId === 'knee-arthroplasty') {
      setSelectedTool('knee-arthroplasty');
    }
  };
  ...
  // If Knee Arthroplasty tool is selected, show it
  if (selectedTool === 'knee-arthroplasty') {
    return (
      <div className="w-full max-w-6xl mx-auto">
        {/* BIG RED WARNING BANNER */}
        <div className="bg-red-50 border-4 border-red-400 p-8 mb-6 text-center rounded-lg shadow-lg">
      ...
      <div className="bg-gray-50 p-4 mt-6 rounded text-sm text-gray-600 border">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-xs">Version 2.0 - February 2026</p>
          </div>
